...
//Update SimpleMenu for 16PIN display connect
//by Maxivimax
...
public:
    ...
    simpleMenu
    (const menuStruct* const pointCtrls, LiquidCrystal& objectLCD) :
